...
final class FeedViewController: UIViewController {
	...
	override func viewDidLoad() {
        ...
        self.navigationItem.title = Localization.feed
	}
}
...
//        let viewModel = FeedCardViewModel(title: "card cell \(indexPath.item)", imageName: "feed1")
        cell.containerView.updateCard(with: viewModel)
             return cell
         }
